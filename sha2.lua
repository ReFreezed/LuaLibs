...
-- License: MIT (http://lua-users.org/lists/lua-l/2014-08/msg00628.html)
-- Source: http://lua-users.org/wiki/SecureHashAlgorithm
----------------------------------------------------------------------
-- Edit: Slightly modified to work with BitOp in Lua 5.1
----------------------------------------------------------------------


local bit = require("bit")
local band, rrotate, bxor, rshift, bnot = bit.band, bit.ror, bit.bxor, bit.rshift, bit.bnot
